...
import { ArrowLeftIcon, FileIcon } from 'tdesign-icons-vue-next'
...
const fetchProjectDetail = async () => {
  ...
  try {
    ...
    MessagePlugin.error('获取静态项目详情失败')
    console.error(error)
  } finally {
    loading.value = false
  }
      ...
      <t-card class="detail-card" :bordered="false">
        ...
        <div class="detail-section">
          ...
          <t-space>
            ...
            <t-button theme="default">在文件管理器中打开</t-button>
          </t-space>
        </div>
      </t-card>
    </div>
