...
import { ArrowLeftIcon, BookIcon } from 'tdesign-icons-vue-next'
    ...
    <div v-else-if="project" class="detail-content">
      <t-card class="detail-card" :bordered="false">
        <div class="card-title">
          <BookIcon class="title-icon" />
          <h2>{{ project.name }}</h2>
          <t-tag theme="success">库</t-tag>
        </div>
        ...
        <div class="detail-section">
          ...
          <t-space>
            ...
            <t-button theme="default">查看文档</t-button>
          </t-space>
        </div>
      </t-card>
    </div>
