...
import { ArrowLeftIcon, FolderIcon, PlayCircleIcon, CodeIcon, BrowseIcon } from 'tdesign-icons-vue-next'
...
// 启动开发服务器
const startDev = () => {
  router.push(`/project/${route.params.id}/dev`)
}

// 构建项目
const startBuild = () => {
  router.push(`/project/${route.params.id}/build`)
}

// 预览项目
const startPreview = () => {
  router.push(`/project/${route.params.id}/preview`)
}
  ...
  <div class="project-detail-page">
    <div class="page-header">
      ...
      <div class="header-right">
        <t-space>
          <t-button theme="primary" @click="startDev">
            <template #icon><PlayCircleIcon /></template>
            启动
          </t-button>
          <t-button theme="success" @click="startBuild">
            <template #icon><CodeIcon /></template>
            打包
          </t-button>
          <t-button theme="default" @click="startPreview">
